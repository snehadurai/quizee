...
const QuestionWiseAnalysis = () => {
  ...
  useEffect(() => {
    const fetchD = async () => {
      try {
        const res = await newRequest.get(`/api/quizzes/${quizId}`);
    ...
    const fetchD = async () => {
      try {
        ...
        const res = await newRequest.get(
          `api/quizzes/questions/${quizId}`
        );
        console.log('question data effect',res.data)
  ...
  console.log('question data',allQuestionsData);
